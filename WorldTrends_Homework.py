...
stats = pd.read_csv("C:\\Users\\Sandratra\\Downloads\\Demographic-Data.csv")
...
LifeExpectancy = {}
LifeExpectancy['CountryCode'] = Country_Code
LifeExpectancy[1960] = Life_Expectancy_At_Birth_1960
LifeExpectancy[2012] = Life_Expectancy_At_Birth_2013
LifeExpectancy

lifeEx = pd.DataFrame(LifeExpectancy)

lifeEx.tail(50)

geography = {"CountryCode": Codes_2012_Dataset,"CountryName": Countries_2012_Dataset, "Region": Regions_2012_Dataset}
geo = pd.DataFrame(geography)
geo

f1 = (geo.CountryCode.isin(lifeEx.CountryCode) == True)
geo = geo[f1]
...
final_dataset = merged_dataset[['CountryName_x','CountryCode','BirthRate','InternetUsers','IncomeGroup',1960,2012,'Region']]
